...
- Distinguir `Domain`, `Application`, `Interface` e `Infrastructure`.
- Leer un escenario BDD y transformarlo en un primer test.
...
1. ¿Qué protege exactamente una regla de dependencia?
2. ¿Por qué un `ViewModel` no debería crear su propio cliente de red?
3. ¿Qué ventaja real te da empezar por un escenario BDD?
4. ¿Qué error típico aparece cuando mezclas lógica de dominio y UI?
5. ¿Qué señal te dice que un test está mejorando diseño y no solo cubriendo líneas?
