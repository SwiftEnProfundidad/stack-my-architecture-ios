...
Hallazgos totales: 10 (P1=0, P2=10)
...
- Salto de complejidad en transicion esperada: `01-fundamentos/06-conectando-la-app.md` (1481) -> `01-fundamentos/entregables-etapa-1.md` (478).
- Salto de complejidad en transicion esperada: `02-integracion/06-composition-root.md` (1858) -> `02-integracion/07-swiftui-enterprise.md` (6161).
- Salto de complejidad en transicion esperada: `02-integracion/08-swift-concurrency-enterprise.md` (3922) -> `02-integracion/09-app-final-etapa-2.md` (1550).
- Salto de complejidad en transicion esperada: `03-evolucion/07-backend-firebase.md` (2530) -> `03-evolucion/entregables-etapa-3.md` (1113).
