...
| 2026-04-11 | **Hub:** `scripts/install-minimal-hub-desktop-app.sh` añadido al repo + README (app `Hub.app` minimal, env `STACK_MY_ARCH_DESKTOP_DIR` / `STACK_MY_ARCH_HUB_APP_NAME`); push `30da5ea`. |