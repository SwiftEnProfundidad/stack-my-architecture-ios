...
[**SwiftUI State moderno →**](05-swiftui-state-moderno.md) — `@Observable`, `@Bindable`, `@State` y `@Environment`: el modelo de datos correcto para SwiftUI con iOS 17+ y cómo se conecta con la arquitectura del scaffold.
