...
[**Structured Concurrency →**](03-structured-concurrency.md) — Task, TaskGroup, async let y `.task(id:)`: concurrencia estructurada aplicada a la arquitectura del scaffold.
